...
if($result_code == 0){
    ...
    //file_put_contents("name_phone.txt","Name and phone: $fullname,$fetched_phone");
    ...
    //file_put_contents("available_balance1.txt","Available balance: $available_balance");
    ...
    //file_put_contents("withdrawals.txt","Available balances: Total withdrawals: $total_withdrawals and total transaction_cost: $sum_transaction_costs");  
        
    $available_balance = $available_balance - ($total_withdrawals + $sum_transaction_costs);
    
    
    
    $message = "$appname: Hello $fullname. You have withdrawn Kshs.".number_format($amount)." from you wallet. Transaction cost is Kshs.".number_format($transaction_cost).". Your new available balance is Kshs.".number_format($available_balance);
    ...
    send_general_sms($fetched_phone,"$appname: Your withdrwal attempt has FAILED. Something went wrong with our systems. Please try again later.");
